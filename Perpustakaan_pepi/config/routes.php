...
if(@$_GET['page'] == ''){
    ...
    if(@$aksi){
            if(@$aksi == 'add'){
                ...
                include "model/user/prosesdeleteuser";
            } 
    }else
    {
    ...
    if(@$aksi){
            if(@$aksi == 'add'){
                ...
                include "model/pegawai/prosesdeletepegawai";
            } 
    }else
    {
    ...
    if(@$aksi){
            if(@$aksi == 'add'){
                ...
                include "model/buku/prosesdeletebuku";
            } 
    }else
    {
    ...
    if(@$aksi){
            if(@$aksi == 'add'){
                ...
                include "model/anggota/prosesdeleteanggota";
            } 
    }else
    {
    ...
    if(@$aksi){
            if(@$aksi == 'add'){
                ...
                include "model/transaksi/prosesdeletetransaksi";
            } 
    }else
    {
