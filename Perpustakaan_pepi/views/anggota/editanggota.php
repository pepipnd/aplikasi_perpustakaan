                        ...
                        <form action="model/anggota/prosesupdateanggota.php" method="POST">
                            ...
                            <table class="table">
                                <tr>
                                    <td>Nama anggota</td>
                                    <td>:</td>
                                    <td><input type="text" class="form-control" maxlength="50" name="Nama_anggota"
                                            id="Nama_anggota" value="<?php echo $hasil['Nama_anggota']?>">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Jenis Kelamin</td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" maxlength="15" name="no_hp"
                                            id="nama_anggota" value="<?php echo $hasil['no_hp']?>"></td>
                                </tr>
                                <tr>
                                    <td colspan="3">
